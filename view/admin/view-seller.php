<?php 
    ...
    include("../../classes/admin/view-seller.class.php");
    $seller = $result;
...
<body>
    ...
    <?php if($seller){?>
    <div class="container mt-3 bg-danger border-4 p-3">
        <div class="card seller-information bg-danger border-0 d-flex justify-content-evenly flex-row flex-wrap mt-3">
