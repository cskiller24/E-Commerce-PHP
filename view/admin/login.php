<?php 
session_start();
    //**Checking if the admin is alrady logged in */
    ...
    if(isset($_GET['err']) && $_GET['err'] == "err"){
        $login_response = "There's an Error in Login";
    }
    if(isset($_GET['err']) && $_GET['err'] == "password"){
        $login_response = "Wrong Username or Password";
    }
    if(isset($_GET['err']) && $_GET['err'] == "empty"){
        $login_response = "Empty Username or Password";
    }
?>
    ...
    <div class="global d-flex justify-content-center align-items-center">
        <div class="card login-form text-center">
            <div class="card-body">
                ...
                <div class="mb-3"><?php echo($login_response);?></div>
                <form action="../../classes/admin/login.class.php" method="post">
                <div class="card-text mb-3">
                ...
                <div class="card-text mb-4">
                    ...
                    <input type="submit" value="submit" name="submit" class="btn btn-warning btn-block w-100 mb-4">
