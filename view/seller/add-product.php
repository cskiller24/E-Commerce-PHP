<?php 
    ...
    if(isset($_GET['err']) && $_GET['err'] == "err"){
        $register_response = "There was an Error in Registering a Product";
    }
    if(isset($_GET['err']) && $_GET['err'] == "emp"){
        $register_response = "Please Enter Details to Register a Product";
    }
    if(isset($_GET['err']) && $_GET['err'] == "ext"){
        $register_response = "Wrong File Extension";
    }
    if(isset($_GET['err']) && $_GET['err'] == "price"){
        $register_response = "Error Price";
    }
    //**SUCCESS */
    if(isset($_GET['success']) && $_GET['success'] == "1"){
        $register_response = "Successfully Registered a Product";
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="global bg-danger rounded-3 border container mt-5 p-3 frame">
        <div class="h1 text-center text-light"><?php echo $register_response; ?></div>
        <form action="../../classes/seller/add-product.class.php" method="post" enctype="multipart/form-data">
            <div class="d-flex flex-wrap">
                <div class="image mx-3 card p-3">
                    <img id="previewFrame">
                    <input type="file" name="product_image" class="form-control" id="Tmp" onchange="previewImage(event)" required>
                </div>
