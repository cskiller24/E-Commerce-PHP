<nav class="navbar navbar-expand-md bg-warning navbar-light py-3">
        <div class="container">
            <a href="#" class="navbar-brand">Demo Shop</a>
                    ...
                    <li class="nav-item px-3">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#"><i class="fas fa-history"></i> Transaction History</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="../seller/homepage.php"><i class="fas fa-shopping-bag"></i> Become a Buyer</a></li>
